...
| Repository | Description | Tags |
|---|---|---|
| [eightbyeight](https://github.com/arran4/eightbyeight) | golang based dithering experiments | cli + experiment + go + utility, dithering, graphics |
...
| Repository | Description | Tags |
|---|---|---|
| [sentencestats](https://github.com/arran4/sentencestats) | Tools to plot character usage in sentences | cli + for-fun + go, character-counter, chart, joke, meme, plotter |

### cli + generator + go
| Repository | Description | Tags |
|---|---|---|
| [editorconfig-guesser](https://github.com/arran4/editorconfig-guesser) | Generates reasonable .editorconfig files for source files. | cli + generator + go, detector, devtool, editorconfig, generators |

### cli + generator + go + image + library + utility
| Repository | Description | Tags |
|---|---|---|
| [go-pattern](https://github.com/arran4/go-pattern) [🔗](https://pkg.go.dev/github.com/arran4/go-pattern) | image.Image patterns | cli + generator + go + image + library + utility, designer, games, image-interface, pattern, patterns, prebuilt, showcase |

### cli + generator + go + utility
| Repository | Description | Tags |
|---|---|---|
| [go-lojban-password-gen](https://github.com/arran4/go-lojban-password-gen) | Lojban password generator - Generate passwords that use lojban | cli + generator + go + utility, binary, lojban, password, password-generator |
...
| Repository | Description | Tags |
|---|---|---|
| [golang-diff](https://github.com/arran4/golang-diff) | A multiline string comparsion library (and tool.) | cli + go + library, cli-app, comparison, diff, testing |
...
| [txtar](https://github.com/arran4/txtar) [🔗](https://pkg.go.dev/github.com/arran4/txtar) | txtar enhanced and with a cli tool | cli + go + library + utility, archive, cli-application, cli-tool, txtar |
...
| Repository | Description | Tags |
|---|---|---|
| [dart_unix_single_instance](https://github.com/arran4/dart_unix_single_instance) [🔗](https://pub.dev/packages/unix_single_instance) | A library which uses unix sockets to ensure a single instance | dart + flutter + library, dartlang, flutter-library, single-instance, unix |
...
### datastore + go + library
| Repository | Description | Tags |
|---|---|---|
| [datastoreutils](https://github.com/arran4/datastoreutils) [🔗](https://pkg.go.dev/github.com/arran4/datastoreutils) | Basic google cloud datastore helpers | datastore + go + library, go-google-app-engine, google-app-engine, google-datastore |
| [dsquery](https://github.com/arran4/dsquery) [🔗](https://pkg.go.dev/github.com/arran4/dsquery) | A google datastore query aggregator and compiler with some minor enhancements | datastore + go + library, google-appengine |
...
| Repository | Description | Tags |
|---|---|---|
| [heatplot](https://github.com/arran4/heatplot) | This program takes a formula and plots the "heat" for any particular location | experiment + go, graph, heatplot, maths, plot, testing |
...
| Repository | Description | Tags |
|---|---|---|
| [send_to_linkwarden](https://github.com/arran4/send_to_linkwarden) [🔗](https://arran4.github.io/send_to_linkwarden/) | Mobile version of Linkwarden | flutter + utility, android, archiving, link, linkwarden, mobile |
...
| Repository | Description | Tags |
|---|---|---|
| [fontlengths](https://github.com/arran4/fontlengths) | Font lengths tester by generating pngs of each font and sorting by length automatically | for-fun + go, font-length, fonts, png-generator |
...
| Repository | Description | Tags |
|---|---|---|
| [g2](https://github.com/arran4/g2) [🔗](https://pkg.go.dev/github.com/arran4/g2) | g2 Gentoo Tools | gentoo + go, gentoo-utils |
...
| Repository | Description | Tags |
|---|---|---|
| [gobookmarks](https://github.com/arran4/gobookmarks) | Landing page for when you open browsers / live bookmarks in go. | github + go + web, bookmarks, github-api, home-page, homepage, live-bookmarks, start-page, startpage |
...
| Repository | Description | Tags |
|---|---|---|
| [go-dynamic-content](https://github.com/arran4/go-dynamic-content) | Lazy or weak file content | go, file-mapped-content, go-library, weak-pointer |
...
| [golang-rcs](https://github.com/arran4/golang-rcs) [🔗](https://pkg.go.dev/github.com/arran4/golang-rcs) | golang rcs parser / generator, and utilities | go, rcs, vcs |
| [goxresources](https://github.com/arran4/goxresources) | go parser for xresource files  | go, dotfiles, xresources |
| [rntocase](https://github.com/arran4/rntocase) | Some utilities to rename files, to upper, lower, title, camel, kebab, darwin case and many more | go, case-changer, commandline-tool, filename, filename-case-changer, golibrary |
| [spacemap](https://github.com/arran4/spacemap) [🔗](https://pkg.go.dev/github.com/arran4/spacemap) | 2d space mapper, using a couple different algorithms with an interchangable interface | go, image-mapper, location, location-lookup, space-mapping |

### go + image
| Repository | Description | Tags |
|---|---|---|
| [golang-frame](https://github.com/arran4/golang-frame) [🔗](https://pkg.go.dev/github.com/arran4/golang-frame) | A simple golang image frame drawing library (Draws a frame around something.) | go + image |
...
| Repository | Description | Tags |
|---|---|---|
| [whirlpool-forum-rss](https://github.com/arran4/whirlpool-forum-rss) | An RSS Generator for the Whirlpool.net.au forums | rss, rss-gen, whirlpool, whirlpool-forums |
