...
|---|---|---|---|
| [heatplot](https://github.com/arran4/heatplot) | This program takes a formula and plots the "heat" for any particular location | AFL-3.0 | experiment + go + test, graph, heatplot, maths, plot |
...
| [datastoreutils](https://github.com/arran4/datastoreutils) [🔗](https://pkg.go.dev/github.com/arran4/datastoreutils) | Basic google cloud datastore helpers | BSD-3-Clause | datastore + go + google-app-engine + library, google-datastore |
| [eightbyeight](https://github.com/arran4/eightbyeight) | golang based dithering experiments | BSD-3-Clause | cli + go + utility, dithering, experiment, graphics |
| [fontlengths](https://github.com/arran4/fontlengths) | Font lengths tester by generating pngs of each font and sorting by length automatically | BSD-3-Clause | go, font-length, fonts, for-fun, png-generator |
...
| [go-dynamic-content](https://github.com/arran4/go-dynamic-content) | Lazy or weak file content | BSD-3-Clause | go + library, file-mapped-content, weak-pointer |
| [go-objectutils](https://github.com/arran4/go-objectutils) [🔗](https://pkg.go.dev/github.com/arran4/go-objectutils) | Go objectutils for go.  | BSD-3-Clause | go + library, type-converstion |
| [go-pattern](https://github.com/arran4/go-pattern) [🔗](https://pkg.go.dev/github.com/arran4/go-pattern) | image.Image patterns | BSD-3-Clause | cli + game + generator + go + image + library + utility, designer, image-interface, pattern, patterns, prebuilt, showcase |
...
| [txtar](https://github.com/arran4/txtar) [🔗](https://pkg.go.dev/github.com/arran4/txtar) | txtar enhanced and with a cli tool | BSD-3-Clause | cli + go + library + utility, archive, cli-application, txtar |

### CC-BY-4.0
| Repository | Description | License | Tags |
|---|---|---|---|
| [arran4.github.io](https://github.com/arran4/arran4.github.io) [🔗](https://arran4.github.io/) | A nausiatingly personal github page. | CC-BY-4.0 | hugo, github, github-pages, hugo-site, landing-page, personal-page |
...
| Repository | Description | License | Tags |
|---|---|---|---|
| [arrans_overlay_workflow_builder](https://github.com/arran4/arrans_overlay_workflow_builder) | A gentoo overlay ebuild workflow builder generator for -bin with a special purpose handler for .appimage binary files | GPL-2.0 | gentoo + github-actions, builder, ebuild, generator, overlay |
| [g2](https://github.com/arran4/g2) [🔗](https://pkg.go.dev/github.com/arran4/g2) | g2 Gentoo Tools | GPL-2.0 | go, gentoo, gentoo-utils |
| [g2-action](https://github.com/arran4/g2-action) | g2 github workflow action | GPL-2.0 | gentoo + github-actions, ci, g2, workflows |
| [git-tag-inc-action](https://github.com/arran4/git-tag-inc-action) [🔗](https://github.com/arran4/git-tag-inc) | An action for incrementing semantic git tags | GPL-2.0 | git-tag-inc, github-actions, semantic-tagging, semantic-versions, tag-manager |
...
| [dart_unix_single_instance](https://github.com/arran4/dart_unix_single_instance) [🔗](https://pub.dev/packages/unix_single_instance) | A library which uses unix sockets to ensure a single instance | MIT | dart + flutter + library, single-instance, unix |
...
| [dsquery](https://github.com/arran4/dsquery) [🔗](https://pkg.go.dev/github.com/arran4/dsquery) | A google datastore query aggregator and compiler with some minor enhancements | MIT | datastore + go + google-app-engine + library |
| [editorconfig-guesser](https://github.com/arran4/editorconfig-guesser) | Generates reasonable .editorconfig files for source files. | MIT | cli + go, detector, devtool, editorconfig, generator, generators |
...
| [git-barcode-sheet](https://github.com/arran4/git-barcode-sheet) [🔗](https://arran4.github.io/barcode-cheatsheets) | Git barcode based cheat sheet | MIT | cheatsheet, barcode-cheatsheet, barcodes, git, git-barcodes, git-cheatsheet |
...
| [sentencestats](https://github.com/arran4/sentencestats) | Tools to plot character usage in sentences | MIT | cli + go, character-counter, chart, for-fun, joke, meme, plotter |
| [spacemap](https://github.com/arran4/spacemap) [🔗](https://pkg.go.dev/github.com/arran4/spacemap) | 2d space mapper, using a couple different algorithms with an interchangable interface | MIT | go + library, image-mapper, location, location-lookup, space-mapping |
...
| [vim-barcode-sheet](https://github.com/arran4/vim-barcode-sheet) [🔗](https://arran4.github.io/barcode-cheatsheets) | Vim Barcodes Cheat Sheet to help with vim  | MIT | cheatsheet, vim |
